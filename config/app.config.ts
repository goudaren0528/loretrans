export const APP_CONFIG = {
  ...
  languages: {
    ...
    supported: [
      ...
      { code: 'si', name: 'Sinhala', nativeName: 'සිංහල', slug: 'sinhala' },
      { code: 'am', name: 'Amharic', nativeName: 'አማርኛ', slug: 'amharic' },
      { code: 'km', name: 'Khmer', nativeName: 'ខ្មែរ', slug: 'khmer' },
      { code: 'ne', name: 'Nepali', nativeName: 'नेपाली', slug: 'nepali' },
      { code: 'mg', name: 'Malagasy', nativeName: 'Malagasy', slug: 'malagasy' },
    ],
    // 目标语言（主要是英文）
