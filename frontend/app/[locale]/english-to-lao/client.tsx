...
const englishtolaoFAQ = [
  {
    question: "Is this English to Lao translator accurate?",
  ...
  {
    question: "Can I translate documents from English to Lao?",
    answer: "Yes! Our document translation feature supports PDF, Word, and text files. Upload your English document and get a Lao translation while preserving the original formatting."
  },
  {
...
export default function CreoleToEnglishClient() {
  ...
  return (
    <div className="min-h-screen">
      ...
      />
      <FAQStructuredData questions={englishtolaoFAQ} />
      <HowToStructuredData 
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {englishtolaoExamples.map((example, index) => (
