...
export const metadata: Metadata = {
  ...
  description: 'Translate English to Lao (ລາວ) instantly with our AI-powered translator. Convert ລາວ text to English with high accuracy. Support for long texts up to 5,000 characters.',
  keywords: ['English to Lao translation', 'English to ລາວ', 'English to Lao translator', 'free English to Lao translation', 'English Lao converter', 'queue translation'],
  openGraph: {
    title: 'English to Lao Translation - Free AI Translator',
    description: 'Translate English to Lao (ລາວ) instantly with AI. Support for long texts and queue processing.',
    url: 'https://loretrans.com/english-to-lao',
    siteName: 'LoReTrans',
    locale: 'en_US',
    type: 'website',
  },
  ...
  alternates: {
    canonical: 'https://loretrans.com/english-to-lao',
  },
}
...
const englishtolaoFAQs = [
  ...
  },
  {
    ...
    answer: "Yes, our English to Lao translation service is completely free. Short texts translate instantly, while longer texts use our queue system for registered users."
  },
  {
    question: "How long can the text be for English to Lao translation?",
  ...
  },
  {
    ...
    answer: "Yes, our translator fully supports the Haitian Creole script (ລາວ) and handles the unique characteristics of the Lao writing system, including proper character encoding and text direction."
  },
  {
...
const features = [
  {
    ...
    description: "Advanced NLLB technology ensures accurate English to Lao translations with cultural context",
    icon: "🤖"
  },
  {
    title: "Bidirectional Support",
    description: "Seamlessly switch between English-to-Lao and Lao-to-English translation",
    icon: "🔄"
  },
  {
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          ...
          "description": "Free AI-powered English to Lao translation tool with high accuracy and queue processing.",
          "url": "https://loretrans.com/en/english-to-lao",
        ...
        dangerouslySetInnerHTML={{
          ...
          "itemListElement": [
                    ...
                    },
                    {
                              ...
                              "position": 3,
                              "name": "English to Lao",
                              "item": "https://loretrans.com/en/english-to-lao"
                    }
          ]
}, null, 2)
        }}
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Translate English to Lao (ລາວ) instantly with our advanced AI translator. 
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="mt-4 text-lg text-gray-600">
                Professional-grade English to Lao translation with modern features
              </p>
            </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4 text-gray-600 leading-relaxed">
                  <p>
                    ...
                    Our AI translator respects these linguistic characteristics to provide accurate English to Lao translations.
                  </p>
                  <p>
                    Whether you're translating English documents to Lao, communicating with Lao speakers, or learning languages, 
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="mt-4 text-lg text-gray-600">
                Everything you need to know about our English to Lao translator
              </p>
            </div>
