...
const englishtocreoleFAQ = [
  {
    question: "Is this English to Haitian Creole translator accurate?",
    answer: "Our translator uses Meta's NLLB AI model, specifically trained on Haitian Creole (Kreyòl Ayisyen). It provides significantly better accuracy than traditional translation services for Haitian Creole text."
  },
  {
    question: "Can I translate documents from English to Haitian Creole?",
    answer: "Yes! Our document translation feature supports PDF, Word, and text files. Upload your English document and get a Haitian Creole translation while preserving the original formatting."
  },
  {
    question: "Do you support Haitian Creole dialects?",
    answer: "Our AI model is trained on standard Haitian Creole (Kreyòl Ayisyen) and works well with common dialectal variations of Haitian Creole."
  },
  {
...
export default function CreoleToEnglishClient() {
  ...
  return (
    <div className="min-h-screen">
      ...
      />
      <FAQStructuredData questions={englishtocreoleFAQ} />
      <HowToStructuredData 
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {englishtocreoleExamples.map((example, index) => (
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="space-y-6">
            {englishtocreoleFAQ.map((faq, index) => (
              <div key={index} className="bg-white p-6 rounded-lg shadow-sm border">
