...
const arabictoenglishFAQ = [
  {
    question: "Is this Arabic translator accurate?",
  ...
  {
    question: "Can I translate documents from Arabic to English?",
    answer: "Yes! Our document translation feature supports PDF, Word, and text files. Upload your Arabic document and get an English translation while preserving the original formatting."
  },
  {
...
export default function CreoleToEnglishClient() {
  ...
  return (
    <div className="min-h-screen">
      ...
      />
      <FAQStructuredData questions={arabictoenglishFAQ} />
      <HowToStructuredData 
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {arabictoenglishExamples.map((example, index) => (
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="space-y-6">
            {arabictoenglishFAQ.map((faq, index) => (
              <div key={index} className="bg-white p-6 rounded-lg shadow-sm border">
