...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://loretrans.com/english-to-burmese',
  },
}
...
const englishtoburmeseFAQs = [
  ...
  },
  {
    ...
    answer: "Yes, our English to Burmese translation service is completely free. Short texts translate instantly, while longer texts use our queue system for registered users."
  },
  {
    question: "How long can the text be for English to Burmese translation?",
...
const features = [
  {
    ...
    description: "Advanced NLLB technology ensures accurate English to Burmese translations with cultural context",
    icon: "🤖"
  },
  {
    title: "Bidirectional Support",
    description: "Seamlessly switch between English-to-Burmese and Burmese-to-English translation",
    icon: "🔄"
  },
  {
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          ...
          "description": "Free AI-powered English to Burmese translation tool with high accuracy and queue processing.",
          "url": "https://loretrans.com/en/english-to-burmese",
        ...
        dangerouslySetInnerHTML={{
          ...
          "itemListElement": [
                    ...
                    },
                    {
                              ...
                              "item": "https://loretrans.com/en/english-to-burmese"
                    }
          ]
}, null, 2)
        }}
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Translate English to Burmese (မြန်မာ) instantly with our advanced AI translator. 
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="mt-4 text-lg text-gray-600">
                Professional-grade English to Burmese translation with modern features
              </p>
            </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4 text-gray-600 leading-relaxed">
                  <p>
                    ...
                    Our AI translator respects these linguistic characteristics to provide accurate English to Burmese translations.
                  </p>
                  <p>
                    Whether you're translating English documents to Burmese, communicating with Burmese speakers, or learning languages, 
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="mt-4 text-lg text-gray-600">
                Everything you need to know about our English to Burmese translator
              </p>
            </div>
