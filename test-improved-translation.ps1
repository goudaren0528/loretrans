...
$testTexts = @{
    "短文本" = "你好，世界！这是一个简单的测试。"
    "中等文本" = "坐在办公室都是问题，下去调研全是办法。调查研究本为发现并更好解决问题，近年来却时常暴露出作风问题。此前曾有媒体报道，某省直单位调研团一共20多人，陪同人员却有50多人，每天六七辆中巴车保障，一天要跑七八个地方。有基层干部吐槽，一些调研内容不够，人数来凑，调研过程常常沦为上车转一转，下车看一看。"
    "长文本" = "坐在办公室都是问题，下去调研全是办法。调查研究本为发现并更好解决问题，近年来却时常暴露出作风问题。此前曾有媒体报道，某省直单位调研团一共20多人，陪同人员却有50多人，每天六七辆中巴车保障，一天要跑七八个地方。有基层干部吐槽，一些调研内容不够，人数来凑，调研过程常常沦为上车转一转，下车看一看。层层陪同，一哄而上，难以发现真问题。客观来说，深入基层调研，广泛接触群众，有助于打破信息茧房，作出科学决策。但广泛性不等于大阵仗，盲目拼凑无关人员参加，获得的往往是无效信息，甚至调研组还会被层层包围，无法与老百姓接触，以至于调研真正需要掌握的实情缩水。调研工作需要更加精准和高效。首先，调研目标要明确，针对具体问题制定详细的调研方案。其次，调研团队要精简，避免人浮于事。最后，调研方法要科学，确保获得真实有效的信息。只有这样，调研工作才能真正发挥作用，为决策提供有力支撑。此外，调研工作还需要建立完善的反馈机制。调研结束后，要及时整理调研成果，形成详细的调研报告。同时，要跟踪调研建议的落实情况，确保调研成果转化为实际行动。这样才能形成调研工作的闭环，真正发挥调研的价值和作用。"
}
...
foreach ($testName in $testTexts.Keys) {
    ...
    Write-Host ""
    Write-Host "📝 测试 $testName (${textLength} 字符)" -ForegroundColor Yellow
