...
export const metadata: Metadata = {
  title: 'API Documentation - Transly Developer Resources',
  description: 'Integrate Transly translation services into your applications. Comprehensive API documentation for developers.',
  keywords: 'API documentation, translation API, developer resources, REST API, integration',
  openGraph: {
    title: 'API Documentation - Transly Developer Resources',
    description: 'Integrate Transly translation services into your applications. Comprehensive API documentation.',
    type: 'website',
    locale: 'en_US',
  },
  alternates: {
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600 sm:text-xl">
              Integrate Transly's powerful translation capabilities into your applications. 
