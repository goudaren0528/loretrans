...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://loretrans.com/spanish-to-english',
  },
}
...
const spanishtoenglishFAQs = [
  ...
  },
  {
    ...
    answer: "Yes, our Spanish to English translation service is completely free. Short texts translate instantly, while longer texts use our queue system for registered users."
  },
  {
    question: "How long can the text be for Spanish to English translation?",
  ...
  },
  {
    ...
    answer: "Yes, our translator fully supports the Haitian Creole script (Español) and handles the unique characteristics of the Spanish writing system, including proper character encoding and text direction."
  },
  {
...
const features = [
  {
    ...
    description: "Advanced NLLB technology ensures accurate Spanish to English translations with cultural context",
    icon: "🤖"
  },
  {
    title: "Bidirectional Support",
    description: "Seamlessly switch between Spanish-to-English and English-to-Spanish translation",
    icon: "🔄"
  },
  {
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          ...
          "description": "Free AI-powered Spanish to English translation tool with high accuracy and queue processing.",
          "url": "https://loretrans.com/en/spanish-to-english",
        ...
        dangerouslySetInnerHTML={{
          ...
          "itemListElement": [
                    ...
                    },
                    {
                              ...
                              "item": "https://loretrans.com/en/spanish-to-english"
                    }
          ]
}, null, 2)
        }}
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Translate Spanish (Español) to English instantly with our advanced AI translator. 
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="mt-4 text-lg text-gray-600">
                Professional-grade Spanish to English translation with modern features
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="mt-4 text-lg text-gray-600">
                Everything you need to know about our Spanish to English translator
              </p>
            </div>
