...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://loretrans.com/tajik-to-english',
  },
}
...
const tajikToenglishFAQs = [
  {
    ...
    answer: "Our AI-powered translator provides high-accuracy Tajik to English translations using advanced NLLB (No Language Left Behind) technology. While very reliable for most content, we recommend human review for critical documents."
  },
  {
    question: "Can I translate English text back to Tajik?",
    answer: "Yes! Our translator supports bidirectional translation. You can easily switch between Tajik-to-English and English-to-Tajik translation using the swap button."
  },
  {
    question: "Is the Tajik to English translator free to use?",
    answer: "Yes, our Tajik to English translation service is completely free. Short texts translate instantly, while longer texts use our queue system for registered users."
  },
  {
    question: "How long can the text be for Tajik to English translation?",
...
const features = [
  {
    ...
    description: "Advanced NLLB technology for accurate Tajik to English translation",
    icon: "🤖"
  },
  {
    title: "Bidirectional Support", 
    description: "Seamlessly switch between Tajik-to-English and English-to-Tajik translation",
    icon: "🔄"
  },
  {
...
export default function TajikToEnglishPage() {
  return (
    <>
      {/* 结构化数据 - SSR优化 */}
      <script
        ...
        dangerouslySetInnerHTML={{
          ...
          "description": "Free AI-powered Tajik to English translation tool with high accuracy and queue processing.",
          "url": "https://loretrans.com/en/tajik-to-english",
        ...
        dangerouslySetInnerHTML={{
          ...
          "itemListElement": [
                    ...
                    },
                    {
                              ...
                              "item": "https://loretrans.com/en/tajik-to-english"
                    }
          ]
}, null, 2)
        }}
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Translate Tajik (Тоҷикӣ) to English instantly with our AI-powered translator. Convert Тоҷикӣ text to English with high accuracy.
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="mt-4 text-lg text-gray-600">
                Professional-grade Tajik to English translation with modern features
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="mt-4 text-lg text-gray-600">
                Learn more about the Tajik language and our translation capabilities
              </p>
            </div>
            
            <div className="prose prose-lg mx-auto text-gray-600">
              <p>
                Tajik (Тоҷикӣ) is a fascinating language with rich cultural heritage. 
                Our AI translator specializes in providing accurate translations between Tajik and English, 
                helping bridge communication gaps and preserve linguistic diversity.
              </p>
              <p>
                Whether you're translating documents, communicating with Tajik speakers, or learning the language, 
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="mt-4 text-lg text-gray-600">
                Everything you need to know about our Tajik to English translator
              </p>
            </div>
