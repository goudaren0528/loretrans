...
export const metadata: Metadata = {
  ...
  keywords: ['English to Igbo translation', 'English to Igbo', 'English to Igbo translator', 'free English to Igbo translation', 'English Igbo converter', 'queue translation'],
  openGraph: {
    ...
    url: 'https://loretrans.com/english-to-igbo',
    siteName: 'LoReTrans',
    locale: 'en_US',
    type: 'website',
  },
  ...
  alternates: {
    canonical: 'https://loretrans.com/english-to-igbo',
  },
}
...
const englishToigboFAQs = [
  {
    ...
    answer: "Our AI-powered translator provides high-accuracy English to Igbo translations using advanced NLLB (No Language Left Behind) technology. While very reliable for most content, we recommend human review for critical documents."
  },
  {
    question: "Can I translate Igbo text back to English?",
    answer: "Yes! Our translator supports bidirectional translation. You can easily switch between English-to-Igbo and Igbo-to-English translation using the swap button."
  },
  {
    question: "Is the English to Igbo translator free to use?",
    answer: "Yes, our English to Igbo translation service is completely free. Short texts translate instantly, while longer texts use our queue system for registered users."
  },
  {
    question: "How long can the text be for English to Igbo translation?",
...
const features = [
  {
    ...
    description: "Advanced NLLB technology for accurate English to Igbo translation",
    icon: "🤖"
  },
  {
    title: "Bidirectional Support", 
    description: "Seamlessly switch between English-to-Igbo and Igbo-to-English translation",
    icon: "🔄"
  },
  {
...
export default function EnglishToIgboPage() {
  return (
    <>
      {/* 结构化数据 - SSR优化 */}
      <script
        ...
        dangerouslySetInnerHTML={{
          ...
          "description": "Free AI-powered English to Igbo translation tool with high accuracy and queue processing.",
          "url": "https://loretrans.com/en/english-to-igbo",
        ...
        dangerouslySetInnerHTML={{
          ...
          "itemListElement": [
                    ...
                    },
                    {
                              ...
                              "item": "https://loretrans.com/en/english-to-igbo"
                    }
          ]
}, null, 2)
        }}
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="mt-4 text-lg text-gray-600">
                Professional-grade English to Igbo translation with modern features
              </p>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg mx-auto text-gray-600">
              <p>
                ...
                Our AI translator specializes in providing accurate translations between English and Igbo, 
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="mt-4 text-lg text-gray-600">
                Everything you need to know about our English to Igbo translator
              </p>
            </div>
