...
export const metadata: Metadata = {
  ...
  description: 'Translate Arabic (العربية) to English instantly with our AI-powered translator. Convert العربية text to English with high accuracy. Free online translation tool.',
  keywords: ['Arabic to English translation', 'العربية to English', 'Arabic translator', 'free Arabic translation', 'Arabic English converter'],
  openGraph: {
    title: 'Arabic to English Translation - Free AI Translator',
    description: 'Translate Arabic (العربية) to English instantly with AI. Free, accurate, and easy to use.',
...
const arabicToEnglishFAQs = [
  ...
  },
  {
    ...
    answer: "Yes, our Arabic to English translation service is completely free with no registration required. Simply enter your Arabic text and get instant English translations."
  },
  {
    question: "What types of text can I translate from Arabic to English?",
    answer: "You can translate various types of Arabic content to English including documents, emails, websites, social media posts, and casual conversations. Our translator handles both formal and informal language styles."
  },
  {
...
const features = [
  {
    ...
    description: "Advanced neural machine translation technology specifically trained for Arabic-English language pairs",
    icon: "🤖"
  },
  {
  ...
  },
  {
    ...
    description: "Switch between Arabic-to-English and English-to-Arabic translation with one click",
    icon: "🔄"
  },
  {
  ...
  {
    title: "Free & Fast",
    description: "Get instant Arabic to English translations at no cost, with results in seconds",
    icon: "⚡"
  },
  {
    ...
    <main className="min-h-screen bg-background">
      ...
      <StructuredData 
        ...
        data={{
          ...
          "description": "Free AI-powered Arabic to English translation tool",
          "url": "https://loretrans.app/arabic-to-english",
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <div className="space-y-4">
              <h1 className="text-4xl md:text-6xl font-bold text-gray-900 leading-tight">
                <span className="text-blue-600">Arabic</span> to English Translation
              </h1>
              <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                Transform Arabic text into clear English instantly with our AI-powered translator.
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <BidirectionalTranslator
            ...
            placeholder="Enter Arabic text to translate to English..."
            showNavigation={true}
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                Why Choose Our Arabic to English Translator?
              </h2>
              <p className="mt-4 text-lg text-gray-600">
                Experience the most advanced AI translation technology tailored for the Arabic-English language pair
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="mt-4 text-lg text-gray-600">
                Everything you need to know about Arabic to English translation
              </p>
            </div>
