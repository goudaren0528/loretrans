...
export const metadata: Metadata = {
  ...
  description: 'Translate Haitian Creole (Kreyòl Ayisyen) to English instantly with our AI-powered translator. Convert Kreyòl Ayisyen text to English with high accuracy. Support for long texts up to 5,000 characters.',
  keywords: ['Haitian Creole to English translation', 'Kreyòl Ayisyen to English', 'Haitian Creole translator', 'free Haitian Creole translation', 'Haitian Creole English converter', 'queue translation'],
  openGraph: {
    title: 'Haitian Creole to English Translation - Free AI Translator',
    description: 'Translate Haitian Creole (Kreyòl Ayisyen) to English instantly with AI. Support for long texts and queue processing.',
    url: 'https://loretrans.com/creole-to-english',
    siteName: 'LoReTrans',
    locale: 'en_US',
    type: 'website',
  },
  ...
  alternates: {
    canonical: 'https://loretrans.com/creole-to-english',
  },
}
...
const creoleToEnglishFAQs = [
  ...
  },
  {
    ...
    answer: "Yes, our Haitian Creole to English translation service is completely free. Short texts translate instantly, while longer texts use our queue system for registered users."
  },
  {
    question: "How long can the text be for Haitian Creole to English translation?",
...
const features = [
  {
    ...
    description: "Advanced NLLB technology ensures accurate Haitian Creole to English translations with cultural context",
    icon: "🤖"
  },
  {
    title: "Bidirectional Support",
    description: "Seamlessly switch between Haitian Creole-to-English and English-to-Haitian Creole translation",
    icon: "🔄"
  },
  {
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          ...
          "description": "Free AI-powered Creole to English translation tool with high accuracy and queue processing.",
          "url": "https://loretrans.com/en/creole-to-english",
        ...
        dangerouslySetInnerHTML={{
          ...
          "itemListElement": [
                    ...
                    },
                    {
                              ...
                              "item": "https://loretrans.com/en/creole-to-english"
                    }
          ]
}, null, 2)
        }}
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Translate Haitian Creole (Kreyòl Ayisyen) to English instantly with our advanced AI translator. 
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="mt-4 text-lg text-gray-600">
                Professional-grade Haitian Creole to English translation with modern features
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="mt-4 text-lg text-gray-600">
                Everything you need to know about our Haitian Creole to English translator
              </p>
            </div>
