...
const englishtoswahiliExamples = [
  {
...
const englishtoswahiliFAQ = [
  {
    question: "Is this English to Swahili translator accurate?",
    answer: "Our translator uses Meta's NLLB AI model, specifically trained on Swahili (Kiswahili). It provides significantly better accuracy than traditional translation services for Swahili text."
  },
  {
    question: "Can I translate documents from English to Swahili?",
    answer: "Yes! Our document translation feature supports PDF, Word, and text files. Upload your English document and get a Swahili translation while preserving the original formatting."
  },
  {
    question: "Do you support Swahili dialects?",
    answer: "Our AI model is trained on standard Swahili (Kiswahili) and works well with common dialectal variations of Swahili."
  },
  {
...
export default function CreoleToEnglishClient() {
  ...
  return (
    <div className="min-h-screen">
      ...
      />
      <FAQStructuredData questions={englishtoswahiliFAQ} />
      <HowToStructuredData 
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {englishtoswahiliExamples.map((example, index) => (
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="space-y-6">
            {englishtoswahiliFAQ.map((faq, index) => (
              <div key={index} className="bg-white p-6 rounded-lg shadow-sm border">
