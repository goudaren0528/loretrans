...
- [ ] 6.1.7 社交登录集成（Google OAuth，可选功能）
...
- [ ] 6.2.5 用户数据安全存储（敏感信息保护）
    - **任务描述**: 实现敏感数据加密存储，配置数据库安全访问策略
    - **产品文档出处**: product.md - 安全与合规 - 数据安全
- [ ] 6.2.6 数据备份与恢复策略（Supabase自动备份）
...
- [ ] 6.3.2 API路由权限保护（Supabase JWT验证）
    - **任务描述**: 在Next.js API路由中集成Supabase JWT验证，保护需要登录的接口
    - **产品文档出处**: product.md - 用户权限管理 - API路由权限保护
- [ ] 6.3.3 前端权限控制组件（基于Supabase Session）
    - **任务描述**: 开发前端权限控制组件，基于Supabase Session状态显示不同内容
    - **产品文档出处**: product.md - 用户权限管理 - 前端权限控制
- [ ] 6.3.4 管理员权限系统（可选功能）
    - **任务描述**: 实现管理员角色系统，支持后台管理功能（后期扩展）
    - **产品文档出处**: product.md - 用户权限管理 - 管理员权限
...
- [ ] 10.2.4 免费用户文档大小限制（5MB vs 50MB）
    - **任务描述**: 实现基于用户类型的文档大小限制，免费用户5MB，付费用户50MB
